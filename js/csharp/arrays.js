...
// ========== DADOS DOS EXERCÍCIOS DE VETORES E MATRIZES EM C# ==========
...
class Program {
    static void Main() {
        ...
        if (posicao != -1) {
            Console.WriteLine($"Valor {busca} encontrado na posição {posicao + 1}");
        } else {
            Console.WriteLine($"Valor {busca} não encontrado no array");
        }
    }
}`,
    testCases: [
...
class Program {
    static void Main() {
        ...
        Console.Write($"Números primos até {n}: ");
        for (int i = 2; i <= n; i++) {
            if (ehPrimo[i]) {
                Console.Write(i);
...
class Program {
    static void Main() {
        ...
        Console.WriteLine("Matriz Identidade 3x3:");
        for (int i = 0; i < TAMANHO; i++) {
            for (int j = 0; j < TAMANHO; j++) {
...
class Program {
    static void Main() {
        ...
        // Leitura da matriz A
        Console.WriteLine("=== MATRIZ A (2x3) ===");
        ...
        // Leitura da matriz B
        Console.WriteLine("=== MATRIZ B (3x2) ===");
        ...
        // Exibe o resultado
        Console.WriteLine("=== MATRIZ RESULTADO C (2x2) ===");
        for (int i = 0; i < LINHAS_A; i++) {
            for (int j = 0; j < COLUNAS_B; j++) {
                Console.Write(C[i, j] + " ");
            }
...
class Program {
    static void Main() {
        ...
        Console.WriteLine("Digite o tabuleiro do jogo da velha:");
        for (int i = 0; i < TAMANHO; i++) {
            for (int j = 0; j < TAMANHO; j++) {
                Console.Write($"Posição [{i + 1}][{j + 1}]: ");
                tabuleiro[i, j] = char.Parse(Console.ReadLine());
            }
        }
        ...
        if (vencedor) {
            Console.WriteLine($"{jogadorVencedor} venceu!");
        } else {
            Console.WriteLine("Empate ou jogo incompleto!");
        }
    }
}`,
    testCases: [
...
function renderConceitosVetoresMatrizes() {
  ...
  return `
    <div class="content-card">
      <h2 class="card-title">📦 Arrays e Matrizes em C#</h2>
...
Console.WriteLine(vetor[0]);  // Imprime 10</code></pre>
      </div>
...
Console.WriteLine(vetor[0]);  // 15
Console.WriteLine(vetor[1]);  // 22
Console.WriteLine(vetor[4]);  // 11</code></pre>
      </div>
    </div>
...
Console.WriteLine(matriz[0, 0]);  // 15
Console.WriteLine(matriz[1, 1]);  // 11</code></pre>
      </div>
    </div>
...
for (int i = 0; i < matriz.GetLength(0); i++) {
    ...
    <div class="content-card">
      <h2 class="card-title">📋 Métodos Úteis de Array em C#</h2>
      <div class="operators-table">
        ...
        <div class="operator-row">
          <div><code>GetLength()</code></div>
          <div>Retorna o tamanho de uma dimensão</div>
          <div><code>matriz.GetLength(0)</code></div>
        </div>
        <div class="operator-row">
          <div><code>Sort()</code></div>
          <div>Ordena o array</div>
          <div><code>Array.Sort(arr)</code></div>
        </div>
        <div class="operator-row">
          <div><code>Reverse()</code></div>
          <div>Inverte a ordem</div>
          <div><code>Array.Reverse(arr)</code></div>
        </div>
        <div class="operator-row">
          <div><code>IndexOf()</code></div>
          <div>Busca um valor</div>
          <div><code>Array.IndexOf(arr, valor)</code></div>
        </div>
      </div>
      ...
      <div class="info-callout" style="margin-top: 1rem;">
        ...
        <div>
          ...
          <br>• Use <code>matriz.GetLength(0)</code> para linhas e <code>GetLength(1)</code> para colunas
          <br>• C# oferece métodos úteis como <code>Array.Sort()</code>, <code>Array.Reverse()</code> e <code>Array.IndexOf()</code>
        </div>
      </div>
    </div>
  `;
