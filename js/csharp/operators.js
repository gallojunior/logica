const operadoresExercises = [
  {
    ...
    statement: "Escreva um programa em C# que calcule a área de um retângulo, dados seu comprimento e largura.",
...
class Program {
    static void Main() {
        ...
        bool resultado = (num1 > num2) && ((num1 - num2) > 10);
...
class Program {
    static void Main() {
        Console.Write("Informe o valor do primeiro resistor (Ω): ");
        double r1 = double.Parse(Console.ReadLine());
        
        Console.Write("Informe o valor do segundo resistor (Ω): ");
        double r2 = double.Parse(Console.ReadLine());
        
        double req = (r1 * r2) / (r1 + r2);
        
        Console.WriteLine($"A resistência equivalente é: {req} Ω");
    }
}`,
    testCases: [
...
// Renderiza a seção de conceitos em C#
function renderConceitosOperadores() {
  return `
    <div class="content-card">
      <h2 class="card-title">📌 Expressões em C#</h2>
      <p>Uma expressão em C# é uma <strong>combinação de valores, variáveis, operadores e funções</strong> que são interpretados e produzem um valor.</p>
    </div>
    ...
    <div class="content-card">
      ...
      <div class="code-example">
        <div class="code-example-header">
          ...
          <span>Atribuição em C#</span>
        </div>
        <pre><code>int x = 10;
int y = x;
int z = x + y;
int resultado = int.Parse(Console.ReadLine());</code></pre>
      </div>
    </div>
    
    <div class="content-card">
      <h2 class="card-title">➕ Operadores Aritméticos em C#</h2>
    ...
    <div class="content-card">
      <h2 class="card-title">⚖️ Operadores de Comparação em C#</h2>
      <div class="operators-table">
        <div class="operator-row header">
          <div>Operador</div>
          <div>Descrição</div>
    ...
    <div class="content-card">
      <h2 class="card-title">🔀 Operadores Lógicos em C#</h2>
      <div class="operators-table">
        <div class="operator-row header">
          <div>Operador</div>
          <div>Descrição</div>
  ...
  return `
    <div class="exercises-filter">
      <div class="filter-header">
        <span>📋 Exercícios de Operadores (C#)</span>
...
function renderOperatorsPage() {
  return `
    <div class="page-header">
      <h1 class="page-title"><span>➕</span> Operadores em C#</h1>
