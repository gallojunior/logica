// js/java/operators.js

const operadoresExercises = [
  {
    id: 1,
    title: "Cálculo de Área do Retângulo",
    statement: "Escreva um programa em Java que calcule a área de um retângulo, dados seu comprimento e largura.",
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.print("Informe o tempo (horas): ");
...
public class Main {
    public static void main(String[] args) {
        ...
        boolean resultado = (num1 > num2) && ((num1 - num2) > 10);
...
public class Main {
    public static void main(String[] args) {
        ...
        double salarioAposINSS = salarioBruto - inss;
        double ir = salarioAposINSS * 0.15;
        double salarioLiquido = salarioAposINSS - ir;
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(valido ? "Válido" : "Inválido");
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.print("Informe o valor do primeiro resistor (Ω): ");
        double r1 = scanner.nextDouble();

        System.out.print("Informe o valor do segundo resistor (Ω): ");
        double r2 = scanner.nextDouble();

        double req = (r1 * r2) / (r1 + r2);

        System.out.println("A resistência equivalente é: " + req + " Ω");
...
// Renderiza a seção de conceitos em Java
function renderConceitosOperadores() {
  return `
    <div class="content-card">
      <h2 class="card-title">📌 Expressões em Java</h2>
      <p>Uma expressão em Java é uma <strong>combinação de valores, variáveis, operadores e chamadas de métodos</strong> que é avaliada para produzir um valor.</p>
    </div>
    ...
    <div class="content-card">
      ...
      <div class="code-example">
        <div class="code-example-header">
          ...
          <span>Atribuição em Java</span>
        </div>
        <pre><code>int x = 10;
int y = x;
int z = x + y;
int resultado = scanner.nextInt();</code></pre>
      </div>
    </div>
    
    <div class="content-card">
      <h2 class="card-title">➕ Operadores Aritméticos em Java</h2>
    ...
    <div class="content-card">
      <h2 class="card-title">⚖️ Operadores de Comparação em Java</h2>
      <div class="operators-table">
        <div class="operator-row header">
          <div>Operador</div>
          <div>Descrição</div>
    ...
    <div class="content-card">
      <h2 class="card-title">🔀 Operadores Lógicos em Java</h2>
      <div class="operators-table">
        <div class="operator-row header">
          <div>Operador</div>
          <div>Descrição</div>
  ...
  return `
    <div class="exercises-filter">
      <div class="filter-header">
        <span>📋 Exercícios de Operadores (Java)</span>
...
function renderOperatorsPage() {
  ...
  return `
    <div class="page-header">
      <h1 class="page-title"><span>➕</span> Operadores em Java</h1>
