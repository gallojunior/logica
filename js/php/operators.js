const operadoresExercises = [
  {
    ...
    statement: "Escreva um programa em PHP que calcule a área de um retângulo, dados seu comprimento e largura.",
    input: "comprimento = 5, largura = 3",
    output: "Área = 15",
    code: `<?php
echo "Informe o comprimento: ";
...
?>`,
  ...
  },
  {
    ...
    output: "tempF = 86",
    code: `<?php
echo "Informe a temperatura em Celsius: ";
$tempC = (float) trim(fgets(STDIN));

$tempF = ($tempC * 9 / 5) + 32;
echo "$tempC°C equivalem a $tempF°F\n";
?>`,
    testCases: [
...
?>`,
  ...
  },
  {
    ...
    code: `<?php
echo "Informe a velocidade (km/h): ";
$velocidade = (float) trim(fgets(STDIN));
echo "Informe o tempo (horas): ";
$tempo = (float) trim(fgets(STDIN));

$distancia = $velocidade * $tempo;
echo "A distância percorrida é: $distancia km\n";
?>`,
    testCases: [
...
?>`,
  ...
  },
  {
    ...
    code: `<?php
echo "Informe o salário bruto: R$ ";
$bruto = (float) trim(fgets(STDIN));
...
?>`,
  ...
  },
  {
    ...
    code: `<?php
echo "Informe o valor do primeiro resistor (Ω): ";
$r1 = (float) trim(fgets(STDIN));
echo "Informe o valor do segundo resistor (Ω): ";
$r2 = (float) trim(fgets(STDIN));

$req = ($r1 * $r2) / ($r1 + $r2);
echo "A resistência equivalente é: $req Ω\n";
?>`,
    testCases: [
...
// Renderiza a seção de conceitos em PHP
function renderConceitosOperadores() {
  return `
    <div class="content-card">
      <h2 class="card-title">📌 Expressões em PHP</h2>
      <p>Uma expressão em PHP é uma combinação de valores, variáveis, operadores e chamadas de funções que é avaliada para produzir um valor. PHP é uma linguagem fracamente tipada e os tipos são convertidos automaticamente conforme necessário.</p>
    </div>
...
$x = $y + 5;</code></pre>
    ...
    <div class="content-card">
      <h2 class="card-title">➕ Operadores Aritméticos em PHP</h2>
    ...
    <div class="content-card">
      <h2 class="card-title">⚖️ Operadores de Comparação em PHP</h2>
      <div class="operators-table">
        <div class="operator-row header">
          <div>Operador</div>
          <div>Descrição</div>
        ...
        <div class="operator-row">
          <div><code>===</code></div>
          <div>Idêntico (valor e tipo)</div>
          <div><code>5 === "5" // false</code></div>
        </div>
        <div class="operator-row">
          <div><code>!=</code></div>
          <div>Diferente</div>
    ...
    <div class="content-card">
      <h2 class="card-title">🔀 Operadores Lógicos em PHP</h2>
      <div class="operators-table">
        <div class="operator-row header">
          <div>Operador</div>
          <div>Descrição</div>
  ...
  return `
    <div class="exercises-filter">
      <div class="filter-header">
        <span>📋 Exercícios de Operadores (PHP)</span>
...
function renderOperatorsPage() {
  ...
  return `
    <div class="page-header">
      <h1 class="page-title"><span>➕</span> Operadores em PHP</h1>
