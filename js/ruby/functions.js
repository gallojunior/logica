// ========== DADOS DOS EXERCÍCIOS DE FUNÇÕES EM RUBY ==========
const functionsExercises = [
  // NÍVEL 1 - FUNÇÕES BÁSICAS (exercícios 1-3)
  {
    ...
    code: `def mensagem_boas_vindas(nome)
...
mensagem_boas_vindas(nome)`,
    ...
    explanation: "Em Ruby, uma função é declarada com `def`. O parâmetro é usado dentro da string interpolada. A função não retorna valor explicitamente."
  },
  {
    id: 2,
    nivel: 1,
    ...
    input: "10",
    output: "----------",
    code: `def desenhar_linha(tamanho)
  puts '-' * tamanho
end

print "Digite o tamanho da linha: "
tam = gets.chomp.to_i
desenhar_linha(tam)`,
    testCases: [
      { values: { tamanho: 10 }, result: "----------", stepByStep: "Multiplica o caractere pelo tamanho" },
      { values: { tamanho: 5 }, result: "-----", stepByStep: "Multiplica o caractere pelo tamanho" }
    ],
    explanation: "O operador `*` em strings repete o caractere. A função apenas imprime a linha."
  },
  {
    id: 3,
    nivel: 1,
    ...
    input: "5",
    output: "5, 4, 3, 2, 1, 0",
    code: `def contagem_regressiva(inicio)
  inicio.downto(0) do |i|
    print i
    print ", " if i > 0
  end
  puts
...
contagem_regressiva(num)`,
    ...
    explanation: "Usa `downto` para iterar decrescentemente."
  },
...
if verificar_par(numero)
  ...
  puts "O número #{numero} é ÍMPAR"
    ...
    testCases: [
      { values: { num: 8 }, result: "PAR", stepByStep: "8.even? → true → PAR" },
      { values: { num: 7 }, result: "ÍMPAR", stepByStep: "7.even? → false → ÍMPAR" }
    ],
    explanation: "Utiliza o método `even?` do Integer, que retorna true para números pares."
  },
  {
    id: 5,
    nivel: 2,
...
puts "O maior número é #{maior}"`,
  ...
  },
  {
    ...
    code: `def celsius_para_fahrenheit(celsius)
  (celsius * 9.0 / 5.0) + 32
end
...
puts "#{c}°C equivale a #{f}°F"`,
  ...
  // NÍVEL 3 - FUNÇÕES COM CÁLCULOS (exercícios 7-8)
  {
    ...
    code: `def calcular_media(n1, n2, n3)
  (n1 + n2 + n3) / 3.0
end
...
puts "A média das notas é: %.2f" % media`,
    ...
    explanation: "Soma e divide por 3.0 para garantir resultado float."
  },
  {
    id: 8,
    nivel: 3,
    ...
    input: "5",
    output: "5! = 120",
    code: `def calcular_fatorial(num)
  (1..num).reduce(:*) || 1
end
...
puts "#{n}! = #{resultado}"`,
    ...
    explanation: "Usa `reduce` para multiplicar todos os números do range, ou retorna 1 se o range for vazio (num=0)."
  },
  ...
  // NÍVEL 4 - FUNÇÕES COM ARRAYS (exercícios 9-10)
  {
    ...
    statement: "Crie uma função chamada preencher_array que receba um array de 5 posições e o preencha com valores digitados pelo usuário.",
    input: "10, 20, 30, 40, 50",
    output: "Array: 10, 20, 30, 40, 50",
    code: `def preencher_array(arr)
  arr.each_index do |i|
    print "Digite o valor para a posição #{i+1}: "
    arr[i] = gets.chomp.to_i
  end
end

def exibir_array(arr)
  puts "Array: " + arr.join(", ")
end

numeros = Array.new(5)
preencher_array(numeros)
exibir_array(numeros)`,
    testCases: [
      { values: { numeros: [10,20,30,40,50] }, result: "Array: 10, 20, 30, 40, 50", stepByStep: "Função preenche cada posição; função exibe o array" }
    ],
    explanation: "Usamos `each_index` para percorrer os índices e modificar o array recebido. `join` formata a saída."
  },
  {
    id: 10,
    nivel: 4,
...
mostrar_tabuada(n)`,
    ...
    explanation: "Apenas imprime a tabuada usando um laço each."
  }
];
...
function renderConceitosFuncoes() {
  ...
  return `
    <div class="content-card">
      <h2 class="card-title">📦 Funções em Ruby</h2>
      <p>Funções (também chamadas de métodos) são blocos de código reutilizáveis. Em Ruby, toda função retorna o valor da última expressão avaliada.</p>
    ...
    <div class="content-card">
      <h2 class="card-title">🔧 Estrutura de uma Função em Ruby</h2>
      <div class="info-grid">
        <div class="info-grid-item">
          <strong>📌 Nome</strong><br>
          snake_case (letras minúsculas e underlines)
        </div>
        <div class="info-grid-item">
          <strong>📦 Parâmetros</strong><br>
          opcionais, podem ter valores padrão
        </div>
        <div class="info-grid-item">
          <strong>🔄 Retorno</strong><br>
          última expressão (return opcional)
        </div>
        <div class="info-grid-item">
          <strong>📝 Corpo</strong><br>
          qualquer código Ruby válido
        </div>
      </div>
      ...
      <div class="code-example">
        ...
        <pre><code>def nome(param1, param2)
  # código
  valor # retorno implícito
    ...
    <div class="content-card">
      <h2 class="card-title">📝 Declaração de Função em Ruby</h2>
      <div class="code-example">
        <div class="code-example-header">
          <span class="code-icon">📝</span>
  ...
  a + b
      ...
      <div class="code-example">
        <div class="code-example-header">
          <span class="code-icon">📝</span>
          <span>Função com valor padrão</span>
        </div>
        <pre><code>def saudacao(nome = "visitante")
  puts "Olá, #{nome}!"
end</code></pre>
      </div>
      <div class="code-example">
  ...
  false
    ...
    <div class="content-card">
      ...
      <p>Funções que não têm \`return\` explícito e cujo último valor é \`nil\` ou um valor não utilizado são usadas apenas pelo efeito colateral.</p>
      <div class="code-example">
        <div class="code-example-header">
          <span class="code-icon">📝</span>
          <span>Procedimento simples</span>
        </div>
        <pre><code>def imprimir_mensagem(texto)
  puts texto
end</code></pre>
      </div>
    </div>
    ...
    <div class="content-card">
      <h2 class="card-title">📋 Convenções em Ruby</h2>
      <div class="operators-table">
        ...
        <div class="operator-row">
          <div>Métodos com ?</div>
          <div>retornam booleano</div>
          <div><code>par?</code></div>
        </div>
        <div class="operator-row">
          <div>Métodos com !</div>
          <div>modificam o receptor</div>
          <div><code>array.sort!</code></div>
        </div>
      </div>
      <div class="info-callout" style="margin-top: 1rem;">
        <span class="info-icon-callout">📌</span>
        <div>Em Ruby, funções que retornam um valor booleano geralmente terminam com \`?\` (ex: \`even?\`). Funções que modificam o objeto geralmente terminam com \`!\`.</div>
      </div>
    </div>
  ...
  puts "Trabalhemmmm!"
      ...
      <div class="info-callout" style="margin-top: 1rem;">
        ...
        <div>
          ...
          <br>• O retorno implícito torna o código mais limpo
          <br>• Prefira funções pequenas e com uma única responsabilidade
          <br>• Use \`?\` para funções que retornam booleano
        </div>
      </div>
    </div>
  `;
  ...
  return `
    <div class="exercises-filter">
      <div class="filter-header">
        <span>📋 Exercícios de Funções em Ruby</span>
...
function renderFunctionsPage() {
  ...
  return `
    <div class="page-header">
      <h1 class="page-title">⚙️ Funções em Ruby</h1>
